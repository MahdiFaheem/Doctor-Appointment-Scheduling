...
namespace HospitalMgmtSys.Presentaion_Layer
{
    public partial class CreateUser : UserControl
    {
        ...
        //private void PopulatePersonTable(string query = "select * from person, employee, doctor where person.personid = employee.personid and employee.empid = doctor.empid")
