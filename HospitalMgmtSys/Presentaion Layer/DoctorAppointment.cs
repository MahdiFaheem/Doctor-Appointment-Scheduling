...
namespace HospitalMgmtSys.Presentaion_Layer
{
    public partial class DoctorAppointment : UserControl
    {
        ...
        /* internal void GetAppointment(string sql= "select * from appointment where doctorid =1")
         {
             AppointmentRepo appointmentRepo=new AppointmentRepo();
             PersonRepo personRepo = new PersonRepo();
             DataTable docAppointmentsTable = appointmentRepo.GetAllAppointmentInformation(sql);
             PopulateGridView();
         }*/
